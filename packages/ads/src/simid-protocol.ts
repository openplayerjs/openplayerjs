/**
 * SIMID 1.2 wire-protocol definitions — message type constants and message shapes.
 *
 * Shared by `SimidRpcChannel` (transport) and `SimidSession` (session logic).
...
export type PendingResolve = { resolve: (v: unknown) => void; reject: (e: unknown) => void };
