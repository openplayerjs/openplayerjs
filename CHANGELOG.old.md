...
#### [v2.14.12](https://github.com/openplayerjs/openplayerjs/compare/v2.14.11...v2.14.12)

- fix(player): Added type to all buttons in player to avoid using default that could lead; to submit forms; fixes #455 [`#455`](https://github.com/openplayerjs/openplayerjs/issues/455)
- chore: Upgraded packages [`547a373`](https://github.com/openplayerjs/openplayerjs/commit/547a37348752780bf5dafe2df4be9095ee49de5a)
- fix(pipeline): Updated Actions to use Node 22 [`418ce59`](https://github.com/openplayerjs/openplayerjs/commit/418ce597aa195abf2a7bfe4b7a270a06e7d3d2e6)

#### [v2.14.11](https://github.com/openplayerjs/openplayerjs/compare/v2.14.10...v2.14.11)

> 26 November 2025

- build(deps): bump tmp, @release-it/conventional-changelog and release-it [`#452`](https://github.com/openplayerjs/openplayerjs/pull/452)
- build(deps-dev): bump pbkdf2 from 3.1.2 to 3.1.3 [`#449`](https://github.com/openplayerjs/openplayerjs/pull/449)
- Release 2.14.11 [`84abc90`](https://github.com/openplayerjs/openplayerjs/commit/84abc90f3645506ca7bb1cefa8166f2bac734e90)
- fix(player): Added missing try/catch block in HTML5 player to deal with live streaming where ended is out of range; added missing conditional to avoid showing loader when current time is zero and media is paused [`d98402b`](https://github.com/openplayerjs/openplayerjs/commit/d98402bc404cefe90a75f89afca7c07f21efe7cc)
- fix: upgrade core-js from 3.41.0 to 3.42.0 [`619d27c`](https://github.com/openplayerjs/openplayerjs/commit/619d27c35504e5ce4eea0edc0d5e4f2681b9989d)

#### [v2.14.10](https://github.com/openplayerjs/openplayerjs/compare/v2.14.9...v2.14.10)

> 24 April 2025

- Release 2.14.9 [`05d8f7f`](https://github.com/openplayerjs/openplayerjs/commit/05d8f7f9d0c0c2711d9f6b0b5f9777734be82924)
- chore: Installed missing package [`15e49d9`](https://github.com/openplayerjs/openplayerjs/commit/15e49d9f9511b7909b6e5b9c64dafbe9fdb7d885)
- Release 2.14.10 [`ea43b21`](https://github.com/openplayerjs/openplayerjs/commit/ea43b21106a832ebcc803730595ceb67de6a9170)

#### [v2.14.9](https://github.com/openplayerjs/openplayerjs/compare/v2.14.8...v2.14.9)

> 22 April 2025

- fix(player): Added new conditional to ensure that Play button will reset to original state if video ended and a new media source was loaded; updated test and fixed NPM warnings [`7be4d23`](https://github.com/openplayerjs/openplayerjs/commit/7be4d23c1612649a09a094358aa49e9f125c4c50)
- fix: upgrade core-js from 3.40.0 to 3.41.0 [`0beb595`](https://github.com/openplayerjs/openplayerjs/commit/0beb5953b558f8fea2193e99bc0f8ef2cb2ca47b)

#### [v2.14.8](https://github.com/openplayerjs/openplayerjs/compare/v2.14.7...v2.14.8)

> 11 February 2025

- fix: upgrade core-js from 3.39.0 to 3.40.0 [`#431`](https://github.com/openplayerjs/openplayerjs/pull/431)
- fix: upgrade core-js from 3.38.1 to 3.39.0 [`#430`](https://github.com/openplayerjs/openplayerjs/pull/430)
- build(deps-dev): bump elliptic from 6.5.7 to 6.6.0 [`#429`](https://github.com/openplayerjs/openplayerjs/pull/429)
- Release v2.14.8 [`ba4f811`](https://github.com/openplayerjs/openplayerjs/commit/ba4f8114a5d9597aa3f92b04837da3dc171c2cad)
- fix(docs): Fixed table formatting issue [`f564c82`](https://github.com/openplayerjs/openplayerjs/commit/f564c827887bb813b8fb15c7769d9d27e25572ee)
- fix(docs): Fixed typos in JavaScript section [`2620c35`](https://github.com/openplayerjs/openplayerjs/commit/2620c35421150daa929cd252d36813ce04e92fe1)
...
- Release 2.14.7 [`bb9564f`](https://github.com/openplayerjs/openplayerjs/commit/bb9564fec831594af9c285b45c1c1ca2da28e7a2)
