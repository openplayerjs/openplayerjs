...
//         this.player.getControls().getLayer(this.layer).appendChild(this.firstButton);
...
//         this.player.getControls().getLayer(this.layer).appendChild(this.prevButton);
...
//         this.player.getControls().getLayer(this.layer).appendChild(this.nextButton);
...
//         this.player.getControls().getLayer(this.layer).appendChild(this.lastButton);
...
//         this.player.getControls().getLayer(this.layer).appendChild(this.toggleButton);
