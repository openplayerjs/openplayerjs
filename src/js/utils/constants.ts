...
export const NAV = (<any>window).navigator;
export const UA = NAV.userAgent.toLowerCase();
export const IS_IPAD = /ipad/i.test(UA) && !(<any>window).MSStream;
export const IS_IPHONE = /iphone/i.test(UA) && !(<any>window).MSStream;
export const IS_IPOD = /ipod/i.test(UA) && !(<any>window).MSStream;
export const IS_IOS = /ipad|iphone|ipod/i.test(UA) && !(<any>window).MSStream;
...
export const HAS_MSE = ('MediaSource' in (<any>window));
