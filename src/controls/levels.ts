...
import { EVENT_OPTIONS, isAndroid, isIOS, navigator } from '../utils/constants';
...
class Levels implements PlayerComponent {
    ...
    create(): void {
        ...
        this.#events.global.connection = (): void => {
            // Check connectivity to switch levels (only HTML5 since HLS can use adaptive streaming)
