...
class Progress {
    ...
    create() {
        ...
        this.#events.media.play = () => {
            ...
            if (this.#player.activeElement().duration !== Infinity &&
                !this.#player.getElement().getAttribute('op-live__enabled')) {
        ...
        const forcePause = (e) => {
            ...
            const isProgressManipulationAllowed = (value < current && progress?.allowRewind) || (value >= current && progress?.allowSkip);
        ...
        const mobileForcePause = (e) => {
            ...
            if (el.duration !== Infinity) {
                ...
                if ((time < el.currentTime && progress?.allowRewind) ||
