...
=======
    ...
    else if (typeof exports === "object") exports["OpenPlayer"] = factory();
    else root["OpenPlayer"] = factory();
})(this, function () {
...
>>>>>>> Stashed changes
                ...
                function isXml(input) {
                    ...
                    try {
                        ...
                        if (
                            response.getElementsByTagName("parsererror")
                                .length > 0
                        ) {
                            return false;
                        }
...
exports.isAutoplaySupported = exports.predictType = exports.isDashSource = exports.isM3USource = exports.isHlsSource = exports.getExtension = void 0;
  ...
  _createClass(Player, [{
    ...
    value: function init() {
      ...
      for (var i = 0, total = targets.length; i < total; i++) {
        ...
        var player = new Player(target, JSON.parse(target.getAttribute('data-op-settings')));
        player.init();
      }
    }
  }, {
...
=======
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                exports.UA = exports.NAV
                    ? exports.NAV.userAgent.toLowerCase()
                    : null;
                exports.IS_IPAD = exports.UA
                    ? /ipad/i.test(exports.UA) && !window.MSStream
                    : false;
                exports.IS_IPHONE = exports.UA
                    ? /iphone/i.test(exports.UA) && !window.MSStream
                    : false;
                exports.IS_IPOD = exports.UA
                    ? /ipod/i.test(exports.UA) && !window.MSStream
                    : false;
                exports.IS_IOS = exports.UA
                    ? /ipad|iphone|ipod/i.test(exports.UA) && !window.MSStream
                    : false;
                exports.IS_ANDROID = exports.UA
                    ? /android/i.test(exports.UA)
                    : false;
                exports.IS_IE = exports.UA
                    ? /(trident|microsoft)/i.test(exports.NAV.appName)
                    : false;
                exports.IS_EDGE = exports.NAV
                    ? "msLaunchUri" in exports.NAV &&
                      !("documentMode" in document)
                    : false;
                exports.IS_CHROME = exports.UA
                    ? /chrome/i.test(exports.UA)
                    : false;
                exports.IS_FIREFOX = exports.UA
                    ? /firefox/i.test(exports.UA)
                    : false;
                exports.IS_SAFARI = exports.UA
                    ? /safari/i.test(exports.UA) && !exports.IS_CHROME
                    : false;
                exports.IS_STOCK_ANDROID = exports.UA
                    ? /^mozilla\/\d+\.\d+\s\(linux;\su;/i.test(exports.UA)
                    : false;
                exports.HAS_MSE =
                    ...
                    var sourceBufferValidAPI =
                        ...
                        (sourceBuffer.prototype &&
                            typeof sourceBuffer.prototype.appendBuffer ===
                                "function" &&
                            typeof sourceBuffer.prototype.remove ===
                                "function");
                    return (
                        !!isTypeSupported &&
...
>>>>>>> Stashed changes
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function formatTime(seconds, frameRate) {
                    ...
                    s = s % 60;
                    return ""
                        .concat(h > 0 ? "".concat(wrap(h), ":") : "")
                        .concat(wrap(m), ":")
                        .concat(wrap(s))
                        .concat(f ? ":".concat(wrap(f)) : "");
                }
...
>>>>>>> Stashed changes
                ...
                var controls_1 = __importDefault(__webpack_require__(128));

                var media_1 = __importDefault(__webpack_require__(137));

                var ads_1 = __importDefault(__webpack_require__(141));
                    ...
                    _createClass(
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function destroy() {
                                    ...
                                    if (
                                        ...
                                        general_1.isVideo(this.element)
                                    ) {
                                        el.removeEventListener(
                                            "canplay",
                                            this._autoplay.bind(this)
                                        );
                                    }
                            ...
                            },
                            {
                                ...
                                value: function addCaptions(args) {
                                    if (args["default"]) {
                                        var tracks = this.element.querySelectorAll(
                                            "track"
                                        );

                                        for (
                                            var i = 0, total = tracks.length;
                                            i < total;
                                            i++
                                        ) {
                                            tracks[i]["default"] = false;
                                    ...
                                    var el = this.element;
                                    var track = el.querySelector(
                                        'track[srclang="'
                                            .concat(args.srclang, '"][kind="')
                                            .concat(args.kind, '"]')
                                    );
                            ...
                            },
                            {
                                ...
                                value: function _isValid() {
                                    ...
                                    if (
                                        !general_1.isAudio(el) &&
                                        !general_1.isVideo(el)
                                    ) {
                                        return false;
                                    }
                            ...
                            },
                            {
                                ...
                                value: function _wrapInstance() {
                                    var wrapper = document.createElement("div");
                                    wrapper.className =
                                        "op-player op-player__keyboard--inactive";
                                    wrapper.className += general_1.isAudio(
                                        this.element
                                    )
                                        ? " op-player__audio"
                                        : " op-player__video";
                            ...
                            },
                            {
                                ...
                                value: function _createControls() {
                                    if (
                                        constants_1.IS_IPHONE &&
                                        general_1.isVideo(this.element)
                                    ) {
                                        this.getContainer().classList.add(
                                            "op-player__ios--iphone"
                                        );
                                    }
                            ...
                            },
                            {
                                ...
                                value: function _prepareMedia() {
                                    try {
                                        ...
                                        var preload = this.element.getAttribute(
                                            "preload"
                                        );
                                        ...
                                        if (!this.autoplay && this.ads) {
                                            var adsOptions =
                                                this.options && this.options.ads
                                                    ? this.options.ads
                                                    : undefined;
                                            this.adsInstance = new ads_1[
                                                "default"
                                            ](
                                                this,
                                                this.ads,
                                ...
                                value: function _createUID() {
                                    if (this.element.id) {
                                        ...
                                        do {
                                            ...
                                            Player.instances[uid] !== undefined
                                        );
                            ...
                            },
                            {
                                ...
                                value: function _createPlayButton() {
                                    ...
                                    this.playBtn = document.createElement(
                                        "button"
                                    );
                                    this.playBtn.className = "op-player__play";
                                    this.playBtn.tabIndex = 0;
                                    this.playBtn.title = this.options.labels.play;
                                    this.playBtn.innerHTML = "<span>".concat(
                                    ...
                                    this.loader = document.createElement(
                                        "span"
                                    );
                                    this.loader.className = "op-player__loader";
                                    this.loader.tabIndex = -1;
                            ...
                            },
                            {
                                ...
                                value: function _setEvents() {
                                    ...
                                    if (general_1.isVideo(this.element)) {
                                        this.events.loadedmetadata = function () {
                                            ...
                                            if (
                                                _this3.options
                                                    .showLoaderOnInit &&
                                                !constants_1.IS_IOS &&
                                                !constants_1.IS_ANDROID
                                            ) {
                                                _this3.loader.setAttribute(
                                                    "aria-hidden",
                                                    "false"
                                                );

                                                _this3.playBtn.setAttribute(
                                                    "aria-hidden",
                                                    "true"
                                                );
                                            } else {
                                            ...
                                            if (el.paused) {
                                                _this3.playBtn.classList.remove(
                                        ...
                                        this.events.play = function () {
                                            _this3.playBtn.classList.add(
                                                "op-player__play--paused"
                                            );

                                            _this3.playBtn.title =
                                                _this3.options.labels.pause;
                                            ...
                                            if (
                                                _this3.options.showLoaderOnInit
                                            ) {
                                                _this3.playBtn.setAttribute(
                                                    "aria-hidden",
                                                    "true"
                                    ...
                                    Object.keys(this.events).forEach(function (
                                        ...
                                        _this3.element.addEventListener(
                                            event,
                                            _this3.events[event]
                                        );
                                    });
                                        ...
                                        media_2.isAutoplaySupported(
                                            ...
                                            function () {
                                                if (_this4.canAutoplayMuted) {
                                                    ...
                                                    var volumeEl = document.createElement(
                                                        "div"
                                                    );
                                                    var action =
                                                        constants_1.IS_IOS ||
                                                    ...
                                                    volumeEl.className =
                                                        "op-player__unmute";
                                                    volumeEl.innerHTML = "<span>".concat(
                                                        action,
                                                        "</span>"
                                                    );
                                                    volumeEl.tabIndex = 0;
                                                    volumeEl.addEventListener(
                                                        ...
                                                        function () {
                                                            _this4.activeElement().muted = false;
                                                            _this4.activeElement().volume =
                                                                _this4.volume;
                                                            var event = events_1.addEvent(
                                                                "volumechange"
                                                            );
                                                    ...
                                                    _this4.activeElement().muted =
                                                        _this4.element.muted;
                                                    _this4.activeElement().volume =
                                                        _this4.volume;
                                                }
                                                ...
                                                if (_this4.ads) {
                                                    var adsOptions =
                                                        ...
                                                        _this4.options.ads
                                                            ? _this4.options.ads
                                                            : undefined;
                                                    _this4.adsInstance = new ads_1[
                                                        "default"
                                                    ](
                                                        _this4,
                                                        _this4.ads,
                                                        _this4.canAutoplay,
                                                        _this4.canAutoplayMuted,
                                                        adsOptions
                                                    );
                                                } else if (
                                                    _this4.canAutoplay ||
                            ...
                            },
                            {
                                ...
                                value: function _fill() {
                                    if (
                                        !general_1.isAudio(this.element) &&
                                        !constants_1.IS_IPHONE
                                    ) {
                                        this.getContainer().classList.add(
                                            "op-player__full"
                                ...
                                value: function _mergeOptions(playerOptions) {
                                    ...
                                    if (playerOptions) {
                                        ...
                                        objectElements.forEach(function (item) {
                                            _this5.options[item] =
                                                playerOptions[item] &&
                                                Object.keys(playerOptions[item])
                                                    .length
                                                    ? Object.assign(
                                                          Object.assign(
                                                              {},
                            ...
                            },
                            {
                                ...
                                set: function set(media) {
                                    if (
                                        this.media instanceof media_1["default"]
                                    ) {
                                        this.media.mediaFiles = [];
                                        this.media.src = media;
                                    }
...
>>>>>>> Stashed changes
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var IteratorPrototype = __webpack_require__(62)
                    .IteratorPrototype;
                var create = __webpack_require__(41);
                var createPropertyDescriptor = __webpack_require__(17);
                var setToStringTag = __webpack_require__(44);
...
var $find = __webpack_require__(85).find;
var addToUnscopables = __webpack_require__(58);
var arrayMethodUsesToLength = __webpack_require__(90);
=======
                $(
                ...
                $(
                    { target: "Promise", stat: true },
                    {
                        try: function (callbackfn) {
                            var promiseCapability = newPromiseCapabilityModule.f(
                                this
                            );
...
=======
                ...
                var captions_1 = __importDefault(__webpack_require__(129));

                var fullscreen_1 = __importDefault(__webpack_require__(130));

                var levels_1 = __importDefault(__webpack_require__(131));

                var play_1 = __importDefault(__webpack_require__(132));

                var progress_1 = __importDefault(__webpack_require__(133));

                var settings_1 = __importDefault(__webpack_require__(134));

                var time_1 = __importDefault(__webpack_require__(135));

                var volume_1 = __importDefault(__webpack_require__(136));
                    ...
                    _createClass(Controls, [
                        {
                            ...
                            value: function create() {
                                ...
                                var isMediaVideo = general_1.isVideo(
                                ...
                                if (
                                    ...
                                    this.events.mouse.mouseenter = function () {
                                        if (
                                            isMediaVideo &&
                                            !_this.player.activeElement().paused
                                        ) {
                                            _this._stopControlTimer();

                                            if (
                                                _this.player.activeElement()
                                                    .currentTime
                                            ) {
                                                _this.player.playBtn.setAttribute(
                                                    "aria-hidden",
                                                    _this.player.isMedia()
                                                        ? "false"
                                                        : "true"
                                                );

                                                _this.player.loader.setAttribute(
                                                    "aria-hidden",
                                                    "true"
                                                );
                                            } else if (
                                                _this.player.getOptions()
                                                    .showLoaderOnInit
                                            ) {
                                                _this.player.playBtn.setAttribute(
                                                    "aria-hidden",
                                    ...
                                    Object.keys(this.events.media).forEach(
                                        function (event) {
                                            _this.player
                                                .getElement()
                                                .addEventListener(
                                                    event,
                                                    _this.events.media[event]
                                                );
                                        }
                                    );
                        ...
                        },
                        {
                            ...
                            value: function destroy() {
                                ...
                                Object.keys(this.items).forEach(function (
                                    position
                                ) {
                                    _this2.items[position].forEach(function (
                                        item
                                    ) {
                                        if (item.custom) {
                                ...
                                if (typeof window !== "undefined") {
                                    this.timer = window.setTimeout(function () {
                                        if (
                                            ...
                                            _this3.player.playBtn.setAttribute(
                                                "aria-hidden",
                                                "true"
                                            );
                        ...
                        },
                        {
                            ...
                            value: function _setElements() {
                                ...
                                var controls = this.player.getOptions()
                                    .controls;
                                this.items = {
                                    left: [],
                                    middle: [],
                                ...
                                var isVideoEl = general_1.isVideo(
                                    this.player.getElement()
                                );
                                var isAudioEl = general_1.isAudio(
                                    this.player.getElement()
                                );
                                    ...
                                    controls[position]
                                        ...
                                        .forEach(function (el) {
                                            var className = ""
                                                ...
                                                .concat(el.slice(1));
                                            var item = new _this4.controlEls[
                                                className
                                            ](_this4.player, position);
                                ...
                                this.player
                                    ...
                                    .forEach(function (item) {
                                        if (item.position === "right") {
                                            _this4.items[item.position].unshift(
                                                item
                                            );
                                        } else {
                                            _this4.items[item.position].push(
                                                item
                                            );
                                        }
                                    });
                        ...
                        },
                        {
                            ...
                            value: function _buildElements() {
                                ...
                                Object.keys(this.items).forEach(function (
                                    ...
                                    _this5.items[position].forEach(function (
                                        item
                                    ) {
                                        if (item.custom) {
                        ...
                        },
                        {
                            ...
                            value: function _createCustomControl(item) {
                                ...
                                var key = item.title
                                    .toLowerCase()
                                    .replace(" ", "-");
                                control.className = "op-controls__"
                                    .concat(key, " op-control__")
                        ...
                        },
                        {
                            ...
                            value: function _destroyCustomControl(item) {
                                var key = item.title
                                    .toLowerCase()
                                    .replace(" ", "-");
                                var control = this.getContainer().querySelector(
                                    ".op-controls__".concat(key)
                                );
...
>>>>>>> Stashed changes
                ...
                var Captions = (function () {
                    function Captions(player, position) {
                        ...
                        for (
                            var i = 0, total = trackList.length;
                            i < total;
                            i++
                        ) {
                            var selector = 'track[kind="subtitles"][srclang="'
                                .concat(trackList[i].language, '"][label="')
                                .concat(trackList[i].label, '"]');
                            var tag = this.player
                                .getElement()
                        ...
                        if (!tracks.length) {
                            for (
                                var _i = 0, _total = trackList.length;
                                _i < _total;
                                _i++
                            ) {
                    ...
                    _createClass(Captions, [
                        {
                            ...
                            value: function create() {
                                ...
                                this.button.className = "op-controls__captions op-control__".concat(
                                    this.position
                                );
                                ...
                                this.button.setAttribute(
                                    "aria-label",
                                    this.labels.toggleCaptions
                                );
                                this.button.setAttribute(
                                    "data-active-captions",
                                    "off"
                                );
                                this.button.innerHTML = '<span class="op-sr">'.concat(
                                    this.labels.toggleCaptions,
                                    "</span>"
                                );
                                ...
                                var _loop = function _loop(i, total, _tracks) {
                                    ...
                                    if (element.kind === "subtitles") {
                                        if (element["default"]) {
                                            ...
                                            _this.button.setAttribute(
                                                "data-active-captions",
                                                element.srclang
                                            );
                                        }

                                        var trackUrl = general_1.getAbsoluteUrl(
                                            element.src
                                        );

                                        if (
                                            _this.trackList[i] &&
                                            _this.trackList[i].language ===
                                                element.srclang
                                        ) {
                                            if (
                                                _this.trackList[i].cues &&
                                                _this.trackList[i].cues.length
                                            ) {
                                                _this.tracks[
                                                    element.srclang
                                                ] = _this._getNativeCues(
                                                    _this.trackList[i]
                                                );
                                                ...
                                                general_1.request(
                                                    ...
                                                    function (d) {
                                                        ...
                                                        if (
                                                            _this.menu &&
                                                            !_this.menu.querySelector(
                                                                '.op-subtitles__option[data-value="captions-'.concat(
                                                                    _this
                                                                        .trackList[
                                                                        i
                                                                    ].language,
                                ...
                                var container = this.captions.querySelector(
                                    "span"
                                );
                                ...
                                this.events.media.timeupdate = function () {
                                    if (_this.player.isMedia()) {
                                        if (_this.current) {
                                            var currentCues =
                                                _this.tracks[
                                                    _this.current.language
                                                ];

                                            if (currentCues !== undefined) {
                                                var index = _this._search(
                                                    currentCues,
                                                    _this.player.getMedia()
                                                        .currentTime
                                                );
                                                ...
                                                if (
                                                    ...
                                                    general_1.hasClass(
                                                        _this.button,
                                                        "op-controls__captions--on"
                                                    )
                                                ) {
                                                    _this.captions.classList.add(
                                                        "op-captions--on"
                                                    );

                                                    container.innerHTML = _this._sanitize(
                                                        currentCues[index].text
                                                    );
                                                } else {
                                                    _this._hide();
                                                }
                                ...
                                this.events.button.click = function (e) {
                                    ...
                                    if (_this.detachMenu) {
                                        var menus = _this.player
                                            .getContainer()
                                            .querySelectorAll(".op-settings");

                                        for (
                                            var _i2 = 0, _total2 = menus.length;
                                            _i2 < _total2;
                                            ++_i2
                                        ) {
                                            if (menus[_i2] !== _this.menu) {
                                                menus[_i2].setAttribute(
                                                    "aria-hidden",
                                                    "true"
                                                );
                                            }
                                        ...
                                        if (
                                            _this.menu.getAttribute(
                                                "aria-hidden"
                                            ) === "true"
                                        ) {
                                            _this.menu.setAttribute(
                                                "aria-hidden",
                                                "false"
                                            );
                                        } else {
                                ...
                                this.events.button.mouseover = function () {
                                    if (
                                        ...
                                        for (
                                            var _i3 = 0, _total3 = menus.length;
                                            _i3 < _total3;
                                            ++_i3
                                        ) {
                                            if (menus[_i3] !== _this.menu) {
                                                menus[_i3].setAttribute(
                                                    "aria-hidden",
                                                    "true"
                                                );
                                            }
                                ...
                                this.events.button.mouseout = function () {
                                    if (
                                        ...
                                        for (
                                            var _i4 = 0, _total4 = menus.length;
                                            _i4 < _total4;
                                            ++_i4
                                        ) {
                                            menus[_i4].setAttribute(
                                                "aria-hidden",
                                                "true"
                                            );
                                        }
                                ...
                                if (
                                    (this.trackList.length <= 1 &&
                                        !this.detachMenu) ||
                                    (!this.trackList.length && this.detachMenu)
                                ) {
                                    return;
                                }
                                ...
                                this.events.global.click = function (e) {
                                    ...
                                    if (
                                        option.closest(
                                            "#".concat(_this.player.id)
                                        ) &&
                                        general_1.hasClass(
                                            option,
                                            "op-subtitles__option"
                                        )
                                    ) {
                                        var language = option
                                            .getAttribute("data-value")
                                            .replace("captions-", "");
                                        _this.current = Array.from(
                                            _this.trackList
                                        )
                                        ...
                                        if (_this.detachMenu) {
                                            ...
                                            var captions = option.parentElement.parentElement.querySelectorAll(
                                                ".op-settings__submenu-item"
                                            );

                                            for (
                                                var _i5 = 0,
                                                    _total5 = captions.length;
                                                _i5 < _total5;
                                                ++_i5
                                            ) {
                                                captions[_i5].setAttribute(
                                                    "aria-checked",
                                                    "false"
                                                );
                                            }
                                ...
                                if (
                                    typeof this.events.global.click !==
                                    "undefined"
                                ) {
                                    document.addEventListener(
                                        "click",
                                        this.events.global.click
                                    );
                                }
                            },
                        },
                            ...
                            value: function _getCuesFromText(webvttText) {
                                ...
                                for (
                                    ...
                                    if (timecode && i < lines.length) {
                                        ...
                                        var initTime = time_1.timeToSeconds(
                                            timecode[1]
                                        );
                                        entries.push({
                                            endTime: time_1.timeToSeconds(
                                                timecode[3]
                                            ),
                                            identifier: identifier,
                                            settings: isJson(timecode[5])
                                                ? JSON.parse(timecode[5])
                                                : {},
                                            startTime:
                                                initTime === 0 ? 0.2 : initTime,
                                            text: cue,
                                        });
                                    }
                        ...
                        },
                        {
                            ...
                            value: function _getNativeCues(track) {
                                var cues = [];
                                Object.keys(track.cues).forEach(function (
                                    index
                                ) {
                        ...
                        },
                        {
                            ...
                            value: function _hide() {
                                this.captions.classList.remove(
                                    "op-captions--on"
                                );
                        ...
                        },
                        {
                            ...
                            value: function _sanitize(html) {
                                ...
                                for (
                                    var index = 0, n = allElements.length;
                                    index < n;
                                    index++
                                ) {
                                    var attributesObj =
                                        allElements[index].attributes;
                                    var attributes = Array.prototype.slice.call(
                                        attributesObj
                                    );
                                    ...
                                    for (
                                        ...
                                        if (
                                            ...
                                            allElements[index].removeAttribute(
                                                attributes[j].name
                                            );
                                        }
                                    }
                                ...
                                var _loop2 = function _loop2(i, total) {
                                    ...
                                    items.push({
                                        ...
                                        label:
                                            _this3.labels.lang[
                                                track.language
                                            ] || _this3.trackList[i].label,
                                    });
                                };

                                for (
                                    var i = 0, total = this.trackList.length;
                                    i < total;
                                    i++
                                ) {
                                    _loop2(i, total);
...
>>>>>>> Stashed changes
                ...
                var Fullscreen = (function () {
                    function Fullscreen(player, position) {
                        ...
                        this.labels = player.getOptions().labels;
                        this.position = position;
                        this.isFullscreen = document.body.classList.contains(
                            "op-fullscreen__on"
                        );
                        var target = document;
                    ...
                    _createClass(Fullscreen, [
                        {
                            ...
                            value: function create() {
                                ...
                                this.button.className = "op-controls__fullscreen op-control__".concat(
                                    this.position
                                );
                                this.button.tabIndex = 0;
                                ...
                                this.fullscreenEvents.forEach(function (event) {
                                    document.addEventListener(
                                        event,
                                        _this._fullscreenChange.bind(_this)
                                    );
                                });
                                this.button.addEventListener(
                                    "click",
                        ...
                        },
                        {
                            ...
                            value: function destroy() {
                                ...
                                this.fullscreenEvents.forEach(function (event) {
                                    document.removeEventListener(
                                        event,
                                        _this2._fullscreenChange.bind(_this2)
                                    );
                                });
                        ...
                        },
                        {
                            ...
                            value: function _fullscreenChange() {
                                var width = this.isFullscreen
                                    ? 0
                                    : this.fullscreenWidth;
                                var height = this.isFullscreen
                                    ? 0
                                    : this.fullscreenHeight;
                    ...
                    _createClass(Levels, [
                        {
                            ...
                            value: function create() {
                                ...
                                var defaultLabel = menuItems.length
                                    ? menuItems.find(function (items) {
                                          return items.key === _this["default"];
                                      }).label
                                    : this.labels.auto;
                                this.button = document.createElement("button");
                                this.button.className = "op-controls__levels op-control__".concat(
                                    this.position
                                );
                                this.button.tabIndex = 0;
                                ...
                                this.button.setAttribute(
                                    "aria-label",
                                    this.labels.mediaLevels
                                );
                                this.button.setAttribute(
                                    "data-active-level",
                                    this["default"]
                                );
                                this.button.innerHTML = "<span>".concat(
                                    defaultLabel,
                                    "</span>"
                                );
                                ...
                                this.events.media.loadedmetadata = loadLevelsEvent.bind(
                                    this
                                );
                                this.events.media.manifestLoaded = loadLevelsEvent.bind(
                                    this
                                );
                                this.events.media.hlsManifestParsed = loadLevelsEvent.bind(
                                    this
                                );
                                ...
                                this.events.global.click = function (e) {
                                    ...
                                    var currentTime = _this.player.getMedia()
                                        .currentTime;

                                    var isPaused = _this.player.getMedia()
                                        .paused;
                                    ...
                                    if (
                                        ...
                                        if (_this.detachMenu) {
                                            ...
                                            _this.button.innerHTML = "<span>".concat(
                                                option.innerText,
                                                "</span>"
                                            );
                                            var levels = option.parentElement.parentElement.querySelectorAll(
                                                ".op-settings__submenu-item"
                                            );
                            ...
                            value: function _formatMenuItems() {
                                ...
                                items = items
                                    .reduce(function (acc, current) {
                                        var duplicate = acc.find(function (
                                            item
                                        ) {
                                                ...
                                                return '\n                <div class="op-settings__submenu-item" tabindex="0" role="menuitemradio"\n                    aria-checked="'
                                                    .concat(
                                                        _this4["default"] ===
                                                            ...
                                                            ? "true"
                                                            : "false",
                                                        '">\n                    <div class="op-settings__submenu-label '
                                                    )
                                                    .concat(
                                                        className || "",
                                                        '" data-value="levels-'
                    ...
                    _createClass(Play, [
                        {
                            ...
                            value: function create() {
                                ...
                                this.button = document.createElement("button");
                                this.button.type = "button";
                                this.button.className = "op-controls__playpause op-control__".concat(
                                    this.position
                                );
                                this.button.tabIndex = 0;
                                ...
                                this.button.innerHTML = '<span class="op-sr">'
                                    .concat(this.labels.play, "/")
                                    .concat(this.labels.pause, "</span>");
                                this.player
                                    .getControls()
                                    .getContainer()
                                    .appendChild(this.button);
                                ...
                                this.events.media.ended = function () {
                                    if (
                                        _this.player.activeElement().ended &&
                                        _this.player.isMedia()
                                    ) {
                                        _this.button.classList.add(
                                            "op-controls__playpause--replay"
                                        ...
                                        _this.player.getElement().currentTime >=
                                            _this.player.getElement()
                                                .duration ||
                                        _this.player.getElement().currentTime <=
                                            0
                                    ) {
                    ...
                    _createClass(Progress, [
                        {
                            ...
                            value: function create() {
                                ...
                                this.progress.className = "op-controls__progress op-control__".concat(
                                    this.position
                                );
                                this.progress.tabIndex = 0;
                                this.progress.setAttribute(
                                    "aria-label",
                                    this.labels.progressSlider
                                );
                                this.progress.setAttribute(
                                    "aria-valuemin",
                                    "0"
                                ...
                                this.slider.setAttribute(
                                    "aria-label",
                                    this.labels.progressRail
                                );
                                this.slider.setAttribute("role", "slider");
                                this.buffer = document.createElement(
                                    "progress"
                                );
                                ...
                                this.buffer.value = 0;
                                this.played = document.createElement(
                                    "progress"
                                );
                                this.played.className =
                                    "op-controls__progress--played";
                                this.played.setAttribute("max", "100");
                                this.played.setAttribute(
                                    "role",
                                    "presentation"
                                );
                                this.played.value = 0;
                                ...
                                var setInitialProgress = function setInitialProgress() {
                                    ...
                                    if (
                                        ...
                                        !_this.player
                                            .getElement()
                                            .getAttribute("op-live")
                                    ) {
                                        _this.slider.setAttribute(
                                            "max",
                                            "".concat(el.duration)
                                        );

                                        var current = _this.player.isMedia()
                                            ? el.currentTime
                                            : el.duration - el.currentTime;
                                        _this.slider.value = current.toString();

                                        _this.progress.setAttribute(
                                            "aria-valuemax",
                                        ...
                                        _this.slider.style.backgroundSize =
                                            "100% 100%";
                                ...
                                this.events.media.loadedmetadata = setInitialProgress.bind(
                                    this
                                );
                                this.events.controls.controlschanged = setInitialProgress.bind(
                                    this
                                );
                                ...
                                this.events.media.play = function () {
                                    if (
                                        ...
                                        _this.progress.removeAttribute(
                                            "aria-valuenow"
                                        );
                                ...
                                this.events.media.timeupdate = function () {
                                    ...
                                    if (
                                        ...
                                        _this.slider.value = current.toString();
                                        _this.slider.style.backgroundSize = "".concat(
                                            ((current - min) * 100) /
                                                (max - min),
                                            "% 100%"
                                        );
                                        ...
                                        if (
                                            _this.player.getOptions()
                                                .showLiveProgress &&
                                            Math.floor(_this.played.value) >= 99
                                        ) {
                                ...
                                var updateSlider = function updateSlider(e) {
                                    ...
                                    if (
                                        ...
                                        el.currentTime =
                                            Math.round(_this.played.value) >= 99
                                                ? lastCurrentTime
                                                : val;
                                    } else {
                                        el.currentTime = val;
                                ...
                                var mobileForcePause = function mobileForcePause(
                                    e
                                ) {
                                    var el = _this.player.activeElement();
                                    ...
                                    var changedTouches = e.originalEvent
                                    ...
                                    var pos =
                                        x -
                                        general_1.offset(_this.progress).left;
                                    var percentage =
                                        pos / _this.progress.offsetWidth;
                                ...
                                this.events.slider.input = updateSlider.bind(
                                    this
                                );
                                this.events.slider.change = updateSlider.bind(
                                    this
                                );
                                this.events.slider.mousedown = forcePause.bind(
                                    this
                                );
                                this.events.slider.mouseup = releasePause.bind(
                                    this
                                );
                                this.events.slider.touchstart = mobileForcePause.bind(
                                    this
                                );
                                this.events.slider.touchend = releasePause.bind(
                                    this
                                );
                                ...
                                if (
                                    ...
                                    this.events.container.mousemove = function (
                                        e
                                    ) {
                                        var el = _this.player.activeElement();
                                        ...
                                        var pos =
                                            x -
                                            general_1.offset(_this.progress)
                                                .left;
                                        var half =
                                            _this.tooltip.offsetWidth / 2;
                                        var percentage =
                                            pos / _this.progress.offsetWidth;
                                        var time = percentage * el.duration;
                                        ...
                                        var limit =
                                            ...
                                            _this.tooltip.offsetWidth;

                                        if (
                                            pos <= 0 ||
                                            x -
                                                general_1.offset(mediaContainer)
                                                    .left <=
                                                half
                                        ) {
                                            pos = 0;
                                        ...
                                        if (
                                            ...
                                            _this.tooltip.classList.add(
                                                "op-controls__tooltip--visible"
                                            );
                                        } else {
                                            _this.tooltip.classList.remove(
                                                "op-controls__tooltip--visible"
                                            );
                                        }

                                        _this.tooltip.style.left = "".concat(
                                            pos,
                                            "px"
                                        );
                                        _this.tooltip.innerHTML = isNaN(time)
                                            ? "00:00"
                                            : time_1.formatTime(time);
                                    };

                                    this.events.global.mousemove = function (
                                        e
                                    ) {
                                        if (
                                            !e.target.closest(
                                ...
                                Object.keys(this.events.slider).forEach(
                                    function (event) {
                                        _this.slider.addEventListener(
                                            event,
                                            _this.events.slider[event]
                                        );
                                    }
                                );
                                this.progress.addEventListener(
                                    "keydown",
                                    this.player.getEvents().keydown
                                );
                                this.progress.addEventListener(
                                    "mousemove",
                                    this.events.container.mousemove
                                );
                                document.addEventListener(
                                    "mousemove",
                                    this.events.global.mousemove
                                );
                                this.player
                                    .getContainer()
                                    .addEventListener(
                        ...
                        },
                        {
                            ...
                            value: function destroy() {
                                ...
                                Object.keys(this.events.slider).forEach(
                                    function (event) {
                                        _this2.slider.removeEventListener(
                                            event,
                                            _this2.events.slider[event]
                                        );
                                    }
                                );
                        ...
                        },
                        {
                            ...
                            value: function _keydownEvent(e) {
                                ...
                                var key = e.which || e.keyCode || 0;
                                var newStep = this.player.getOptions().step
                                    ? this.player.getOptions().step
                                    : el.duration * 0.05;
                                var step =
                                    el.duration !== Infinity ? newStep : 0;
                    ...
                    _createClass(Settings, [
                        {
                            ...
                            value: function create() {
                                ...
                                this.button = document.createElement("button");
                                this.button.className = "op-controls__settings op-control__".concat(
                                    this.position
                                );
                                this.button.tabIndex = 0;
                                ...
                                this.menu.innerHTML =
                                    '<div class="op-settings__menu" role="menu"></div>';
                                ...
                                this.events.media.controlshidden = this.hideEvent.bind(
                                    this
                                );
                                this.events.media.settingremoved = this.removeEvent.bind(
                                    this
                                );
                                this.events.media.play = this.hideEvent.bind(
                                    this
                                );
                                this.events.media.pause = this.hideEvent.bind(
                                    this
                                );
                                ...
                                this.events.global.click = function (e) {
                                    if (
                                        ...
                                        _this.player.getMedia().playbackRate = parseFloat(
                                            e.target
                                                .getAttribute("data-value")
                                                .replace("speed-", "")
                                        );
                                ...
                                this.events.global.resize = this.hideEvent.bind(
                                    this
                                );
                                this.button.addEventListener(
                                    "click",
                        ...
                        },
                        {
                            ...
                            value: function destroy() {
                                ...
                                if (
                                    this.events.global["settings.submenu"] !==
                                    undefined
                                ) {
                                    document.removeEventListener(
                                        "click",
                        ...
                        },
                        {
                            ...
                            value: function addSettings() {
                                return {
                                    ...
                                    default:
                                        this.player && this.player.getMedia()
                                            ? this.player
                                                  .getMedia()
                                                  .defaultPlaybackRate.toString()
                                            : "1",
                                    key: "speed",
                        ...
                        },
                        {
                            ...
                            value: function addItem(
                                ...
                                menuItem.innerHTML = '<div class="op-settings__menu-label" data-value="'
                                    .concat(key, "-")
                                    .concat(defaultValue, '">')
                                    .concat(
                                        name,
                                        '</div>\n            <div class="op-settings__menu-content">'
                                    )
                                    .concat(
                                        submenu.find(function (x) {
                                ...
                                if (submenu) {
                                    var subItems = '\n                <div class="op-settings__header">\n                    <button type="button" class="op-settings__back">'
                                        .concat(
                                            name,
                                            '</button>\n                </div>\n                <div class="op-settings__menu" role="menu" id="menu-item-'
                                        )
                                        .concat(key, '">\n                    ')
                                        .concat(
                                            submenu
                                ...
                                this.events.global[
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            _this3.menu.classList.add(
                                                "op-settings--sliding"
                                            );

                                            setTimeout(function () {
                                                _this3.menu.innerHTML =
                                                    _this3.originalOutput;

                                                _this3.menu.classList.remove(
                                                    "op-settings--sliding"
                                                );
                                            }, 100);
                                        } else if (
                                            ...
                                            var fragments = target.parentElement
                                                .querySelector(
                                            ...
                                            var _current = target.getAttribute(
                                                "data-value"
                                            );

                                            var value = _current.replace(
                                                "".concat(key, "-"),
                                                ""
                                            );
                                            ...
                                            var menuTarget = _this3.menu.querySelector(
                                                "#menu-item-".concat(
                                                    key,
                                                    " .op-settings__submenu-item[aria-checked=true]"
                                                )
                                            );

                                            if (menuTarget) {
                                                menuTarget.setAttribute(
                                                    "aria-checked",
                                                    "false"
                                                );
                                                ...
                                                setTimeout(function () {
                                                    ...
                                                    var prev = _this3.menu.querySelector(
                                                        '.op-settings__menu-label[data-value="'
                                                            .concat(key, "-")
                                                            .concat(
                                                                defaultValue,
                                                                '"]'
                        ...
                        },
                        {
                            ...
                            value: function removeItem(id, type) {
                                ...
                                var target = this.player
                                    .getElement()
                                    .querySelector(
                                        ".op-settings__submenu-label[data-value="
                                            .concat(type, "-")
                                            .concat(id, "]")
                                    );
                                ...
                                if (
                                    this.player
                                        .getElement()
                                        .querySelectorAll(
                                            ".op-settings__submenu-label[data-value^=".concat(
                                                type,
                                                "]"
                                            )
                                        ).length < minItems
                                    ...
                                    general_1.removeElement(
                                        this.player
                                            .getElement()
                                            .querySelector(
                                                ".op-settings__menu-label[data-value^=".concat(
                                                    type,
                                                    "]"
                                                )
                                            )
                            ...
                            value: function create() {
                                ...
                                var setInitialTime = function setInitialTime() {
                                    ...
                                    if (
                                        ...
                                        var duration = !isNaN(el.duration)
                                            ? el.duration
                                            : 0;
                                        _this.duration.innerText = time_1.formatTime(
                                            duration
                                        );
                                        _this.current.innerText = time_1.formatTime(
                                            el.currentTime
                                        );
                                    } else {
                                        _this.duration.setAttribute(
                                            "aria-hidden",
                                            "true"
                                        );

                                        _this.delimiter.setAttribute(
                                            "aria-hidden",
                                            "true"
                                        );
                                    }
                                ...
                                this.events.media.loadedmetadata = setInitialTime.bind(
                                    this
                                );
                                this.events.controls.controlschanged = setInitialTime.bind(
                                    this
                                );
                                ...
                                this.events.media.timeupdate = function () {
                                    ...
                                    if (
                                        ...
                                        var duration = time_1.formatTime(
                                            el.duration
                                        );
                                ...
                                var controls = this.player
                                    .getControls()
                                    .getContainer();
                                this.container = document.createElement("span");
                                this.container.className = "op-controls-time op-control__".concat(
                                    this.position
                                );
                    ...
                    _createClass(Volume, [
                        {
                            ...
                            value: function create() {
                                ...
                                this.container.className = "op-controls__volume op-control__".concat(
                                    this.position
                                );
                                ...
                                this.container.setAttribute(
                                    "aria-label",
                                    this.labels.volumeSlider
                                );
                                this.slider = document.createElement("input");
                                this.slider.type = "range";
                                this.slider.className =
                                    "op-controls__volume--input";
                                this.slider.tabIndex = -1;
                                this.slider.value = this.player
                                    .getMedia()
                                    .volume.toString();
                                this.slider.setAttribute("min", "0");
                                ...
                                this.display.value =
                                    this.player.getMedia().volume * 10;
                                ...
                                var updateVolume = function updateVolume(
                                    ...
                                    if (
                                        ...
                                        _this.player
                                            .getContainer()
                                            .querySelector(".op-player__unmute")
                                    ) {
                                        general_1.removeElement(
                                            _this.player
                                                .getContainer()
                                ...
                                this.events.slider.input = updateVolume.bind(
                                    this
                                );
                                this.events.slider.change = updateVolume.bind(
                                    this
                                );
...
>>>>>>> Stashed changes
                ...
                var dash_1 = __importDefault(__webpack_require__(138));

                var hls_1 = __importDefault(__webpack_require__(139));

                var html5_1 = __importDefault(__webpack_require__(140));

                var source = __importStar(__webpack_require__(29));
                    ...
                    _createClass(Media, [
                        ...
                        },
                        {
                            ...
                            value: function load() {
                                ...
                                if (
                                    this.media &&
                                    typeof this.media.destroy === "function"
                                ) {
                                    var sameMedia =
                                        this.mediaFiles.length === 1 &&
                                        this.mediaFiles[0].src ===
                                            this.media.media.src;
                                ...
                                this.mediaFiles.some(function (media) {
                                    try {
                                        ...
                                        _this.media = new html5_1["default"](
                                            _this.element,
                                            media
                                        );
                                    }
                                ...
                                try {
                                    if (this.media === null) {
                                        throw new TypeError(
                                            "Media cannot be played with any valid media type"
                                        );
                                    }
                        ...
                        },
                        {
                            ...
                            value: function play() {
                                ...
                                this.promisePlay = new Promise(function (
                                    resolve
                                ) {
                                    resolve();
                                }).then(
                                    this.media.promise.then(this.media.play())
                                );
                        ...
                        },
                        {
                            ...
                            value: function _getMediaFiles() {
                                var mediaFiles = [];
                                var sourceTags = this.element.querySelectorAll(
                                    "source"
                                );
                                ...
                                if (nodeSource) {
                                    mediaFiles.push({
                                        ...
                                        type:
                                            ...
                                            source.predictType(nodeSource),
                                    });
                                }

                                for (
                                    var i = 0, total = sourceTags.length;
                                    i < total;
                                    i++
                                ) {
                        ...
                        },
                        {
                            ...
                            value: function _invoke(media) {
                                ...
                                if (
                                    Object.keys(this.customMedia.media).length
                                ) {
                                    var customRef;
                                    this.customMedia.rules.forEach(function (
                                        rule
                                    ) {
                                        ...
                                        if (type) {
                                            var customMedia =
                                                _this4.customMedia.media[type];
                                            var customOptions =
                                                _this4.options[
                                                    _this4.customMedia
                                                        .optionsKey[type]
                                                ] || undefined;
                                            customRef = customMedia(
                                                _this4.element,
                                                media,
                                                _this4.autoplay,
                                                customOptions
                                    ...
                                    !playHLSNatively &&
                                    source.isHlsSource(media)
                                ) {
                                    var hlsOptions =
                                        this.options && this.options.hls
                                            ? this.options.hls
                                            : undefined;
                                    return new hls_1["default"](
                                        this.element,
                                        media,
                                        this.autoplay,
                                        hlsOptions
                                    ...
                                    var dashOptions =
                                        this.options && this.options.dash
                                            ? this.options.dash
                                            : undefined;
                                    return new dash_1["default"](
                                        this.element,
                                        media,
                                        dashOptions
                                    );
                        ...
                        },
                        {
                            ...
                            get: function get() {
                                return this.media
                                    ? this.media.defaultPlaybackRate
                                    : this.element.defaultPlaybackRate;
                            },
                        },
                        {
                            key: "currentTime",
...
>>>>>>> Stashed changes
                ...
                var native_1 = __importDefault(__webpack_require__(47));
                ...
                var DashMedia = (function (_native_1$default) {
                    ...
                    function DashMedia(element, mediaSource, options) {
                        ...
                        _this = _possibleConstructorReturn(
                            this,
                            _getPrototypeOf(DashMedia).call(
                                this,
                                element,
                                mediaSource
                            )
                        ...
                        _this.promise.then(
                            createInstance.bind(_assertThisInitialized(_this))
                        );
                    ...
                    _createClass(DashMedia, [
                        ...
                        },
                        {
                            ...
                            value: function _assign(event) {
                                if (event.type === "error") {
                                    ...
                                    var errorEvent = events_1.addEvent(
                                        "playererror",
                                        details
                                    );
                        ...
                        },
                        {
                            ...
                            value: function _preparePlayer() {
                                if (
                                    typeof this.player.getDebug()
                                        .setLogToBrowserConsole === "undefined"
                                ) {
                                ...
                                if (
                                    this.options &&
                                    _typeof(this.options.drm) === "object" &&
                                    Object.keys(this.options.drm).length
                                ) {
                        ...
                        },
                        {
                            ...
                            get: function get() {
                                ...
                                if (this.player) {
                                    var bitrates = this.player.getBitrateInfoListFor(
                                        "video"
                                    );
...
=======
                ...
                var HlsMedia = (function (_native_1$default) {
                    ...
                    function HlsMedia(element, mediaSource) {
                        ...
                        _this.promise.then(
                            _this._create.bind(_assertThisInitialized(_this))
                        );
                        ...
                        },
                        {
                            ...
                            value: function _assign(event, data) {
                                if (event === "hlsError") {
                                        ...
                                        switch (type) {
                                            case "mediaError":
                                                ...
                                                if (
                                                    ...
                                                    console.error(msg);
                                                    var mediaEvent = events_1.addEvent(
                                                        type,
                                                        details
                                                    );
                                            ...
                                            case "networkError":
                                                ...
                                                var networkEvent = events_1.addEvent(
                                                    type,
                                                    details
                                                );
                                                this.element.dispatchEvent(
                                            ...
                                            default:
                                                this.player.destroy();
                                                var fatalEvent = events_1.addEvent(
                                                    type,
                                                    details
                                                );
                                                this.element.dispatchEvent(
                                    ...
                                    if (
                                        event === "hlsLevelLoaded" &&
                                        data[1].details.live === true
                                    ) {
                                        this.element.setAttribute(
                                            "op-live",
                                            "true"
                                        );
                                        var timeEvent = events_1.addEvent(
                                            "timeupdate"
                                        );
                        ...
                        },
                        {
                            ...
                            get: function get() {
                                ...
                                if (
                                    this.player &&
                                    this.player.levels &&
                                    this.player.levels.length
                                ) {
                                    Object.keys(this.player.levels).forEach(
                                        function (item) {
                                            var _this6$player$levels$ =
                                                    _this6.player.levels[item],
                                                height =
                                                    _this6$player$levels$.height,
                                                name =
                                                    _this6$player$levels$.name;
                                            var level = {
                                                height: height,
                                                id: item,
                                                label: name || null,
...
=======
                ...
                var HTML5Media = (function (_native_1$default) {
                    ...
                    function HTML5Media(element, mediaFile) {
                        ...
                        _this = _possibleConstructorReturn(
                            this,
                            _getPrototypeOf(HTML5Media).call(
                                this,
                                element,
                                mediaFile
                            )
                        ...
                        if (
                            !general_1.isAudio(element) &&
                            !general_1.isVideo(element)
                        ) {
                            throw new TypeError(
                                "Native method only supports video/audio tags"
                            );
                        }
                    ...
                    _createClass(HTML5Media, [
                        ...
                        },
                        {
                            ...
                            get: function get() {
                                if (!this.levelList.length) {
                                    var levels = this.element.querySelectorAll(
                                        "source[title]"
                                    );

                                    for (
                                        var i = 0, total = levels.length;
                                        i < total;
                                        ++i
                                    ) {
                                        var level = {
                        ...
                        },
                        {
                            key: "level",
                            set: function set(level) {
                                var idx = this.levelList.findIndex(function (
                                    item
                                ) {
...
var HTML5Media = function (_native_1$default) {
  ...
  _createClass(HTML5Media, [{
    ...
    value: function _readMediadataInfo(target) {
      var _this2 = this;

      if (target.track.kind === 'metadata') {
        target.track.mode = 'hidden';
        target.track.addEventListener('cuechange', function (e) {
          ...
          if (cue) {
            ...
            _this2.element.dispatchEvent(_e);
          }
        });
      }
    }
  ...
  _createClass(Ads, [{
    ...
    value: function _resumeMedia() {
      ...
      var triggerEvent = function triggerEvent(eventName) {
        ...
        _this6.element.dispatchEvent(event);
      };
...
=======
                ...
                var Ads = (function () {
                    function Ads(
                        ...
                        this.originalVolume = this.element.volume;
                        this.adsVolume = this.originalVolume;
                        var path = this.adsOptions.debug
                            ? this.adsOptions.url.replace(
                                  /(\.js$)/,
                                  "_debug.js"
                              )
                            : this.adsOptions.url;
                    ...
                    _createClass(Ads, [
                        {
                            ...
                            value: function load() {
                                ...
                                if (
                                    !this.adsOptions.autoPlayAdBreaks &&
                                    !force
                                ) {
                                    return;
                                }
                                ...
                                this.adsStarted = true;
                                this.adsContainer = document.createElement(
                                    "div"
                                );
                                this.adsContainer.id = "op-ads";
                                this.adsContainer.tabIndex = -1;
                        ...
                        },
                        {
                            ...
                            value: function destroy() {
                                ...
                                if (this.events) {
                                    this.events.forEach(function (event) {
                                        _this2.adsManager.removeEventListener(
                                            event,
                                            _this2._assign.bind(_this2)
                                        );
                                    });
                                ...
                                this.events = [];
                                var mouseEvents = this.player.getControls()
                                    .events.mouse;
                                Object.keys(mouseEvents).forEach(function (
                                    event
                                ) {
                                    _this2.adsContainer.removeEventListener(
                                        event,
                                        mouseEvents[event]
                                    );
                                });
                                ...
                                var destroy =
                                    !Array.isArray(this.ads) ||
                                    this.currentAdsIndex > this.ads.length;
                                ...
                                this.element.removeEventListener(
                                    "ended",
                                    this._contentEndedListener.bind(this)
                                );
                            ...
                            value: function _assign(event) {
                                ...
                                switch (event.type) {
                                    case google.ima.AdEvent.Type.LOADED:
                                        if (!ad.isLinear()) {
                                            ...
                                            if (
                                                ...
                                                var waitingEvent = events_1.addEvent(
                                                    "waiting"
                                                );
                                                this.element.dispatchEvent(
                                                    waitingEvent
                                                );
                                                var loadedEvent = events_1.addEvent(
                                                    "loadedmetadata"
                                                );
                                                this.element.dispatchEvent(
                                                    loadedEvent
                                    ...
                                    case google.ima.AdEvent.Type.STARTED:
                                        if (ad.isLinear()) {
                                            this.adsActive = true;
                                            var playEvent = events_1.addEvent(
                                                "play"
                                            );
                                            this.element.dispatchEvent(
                                                playEvent
                                            ...
                                            if (this.media.ended) {
                                                this.adsEnded = false;
                                                var endEvent = events_1.addEvent(
                                                    "adsmediaended"
                                                );
                                                this.element.dispatchEvent(
                                                    endEvent
                                                ...
                                                this.intervalTimer = window.setInterval(
                                                    function () {
                                                        if (
                                                            ...
                                                            _this4.adsCurrentTime = Math.round(
                                                                _this4.adsManager.getRemainingTime()
                                                            );
                                                            var timeEvent = events_1.addEvent(
                                                                "timeupdate"
                                                            );
                                    ...
                                    case google.ima.AdEvent.Type.SKIPPED:
                                        if (ad.isLinear()) {
                                            if (
                                                ...
                                                var skipEvent = events_1.addEvent(
                                                    "adsskipped"
                                                );
                                                this.element.dispatchEvent(
                                                    skipEvent
                                    ...
                                    case google.ima.AdEvent.Type.VOLUME_MUTED:
                                        if (ad.isLinear()) {
                                            var volumeEvent = events_1.addEvent(
                                                "volumechange"
                                            );
                                            this.element.dispatchEvent(
                                                volumeEvent
                                    ...
                                    case google.ima.AdEvent.Type
                                        ...
                                        if (ad.isLinear()) {
                                            ...
                                            if (
                                                ...
                                                var endedEvent = events_1.addEvent(
                                                    "ended"
                                                );
                                                this.element.dispatchEvent(
                                                    endedEvent
                        ...
                        },
                        {
                            ...
                            value: function _error(event) {
                                ...
                                if (
                                    Array.isArray(this.ads) &&
                                    this.ads.length > 1 &&
                                    this.currentAdsIndex <= this.ads.length - 1
                                ) {
                                    if (
                                        this.currentAdsIndex <
                                        this.ads.length - 1
                                    ...
                                    this.load(true);
                                    console.warn(
                                        "Ad warning: ".concat(error.toString())
                                    );
                                } else {
                                    if (
                                        this.adsManager &&
                                        fatalErrorCodes.indexOf(
                                            error.getErrorCode()
                                        ) > -1
                                    ) {
                                        this.adsManager.destroy();
                                    ...
                                    var unmuteEl = this.element.parentElement.querySelector(
                                        ".op-player__unmute"
                                    );
                        ...
                        },
                        {
                            ...
                            value: function _start(manager) {
                                ...
                                Object.keys(mouseEvents).forEach(function (
                                    ...
                                    _this5.adsContainer.addEventListener(
                                        event,
                                        mouseEvents[event]
                                    );
                                });
                        ...
                        },
                        {
                            ...
                            value: function _onContentResumeRequested() {
                                if (this.adsOptions.loop) {
                                    ...
                                    this.element.addEventListener(
                                        "loadedmetadata",
                                        this._loadedMetadataHandler.bind(this)
                                    );
                        ...
                        },
                        {
                            ...
                            value: function _requestAds() {
                                this.adsRequest = new google.ima.AdsRequest();
                                var ads = Array.isArray(this.ads)
                                    ? this.ads[this.currentAdsIndex]
                                    : this.ads;
                                ...
                                var width = this.element.parentElement
                                    .offsetWidth;
                                var height = this.element.parentElement
                                    .offsetHeight;
                                this.adsRequest.linearAdSlotWidth = width;
                                this.adsRequest.linearAdSlotHeight = height;
                                this.adsRequest.setAdWillAutoPlay(
                                    this.autoStart
                                );
                                this.adsRequest.setAdWillPlayMuted(
                                    this.autoStartMuted
                                );
                                this.adsLoader.requestAds(this.adsRequest);
                            },
