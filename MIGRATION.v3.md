...
- [Configuration changes](#configuration-changes)
  - [Options that still exist](#options-that-still-exist-same-key-same-behaviour)
  - [New options in v3](#new-options-in-v3)
  - [Removed options](#removed-options)
  - [Re-introduced options](#re-introduced-options)
- [New additions](#new-additions)
  - [Separate `currentTime` and `duration` controls](#separate-currenttime-and-duration-controls)
  - [Strict UI extension timing (UMD)](#strict-ui-extension-timing-umd)
  - [New plugin / engine model](#new-plugin--engine-model)
- [Removed features](#removed-features)
  - [M(PEG)-DASH removed](#mpeg-dash-removed)
  - [FLV removed](#flv-removed)
  - [Core `levels` / quality API removed](#core-levels--quality-api-removed)
  - [IMA SDK (Google) removed](#ima-sdk-google-removed)
  - [`addElement` and `addControl` API redesigned](#addelement-and-addcontrol-api-redesigned)
